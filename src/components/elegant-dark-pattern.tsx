      ...
      <div className="absolute inset-0">
        ...
        >
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(rgb(0, 255, 170) 0%, rgba(0, 207, 255, 0) 100%)',
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(rgb(0, 255, 170) 0%, rgba(0, 207, 255, 0) 100%)',
              mask: 'linear-gradient(90deg, rgba(70, 55, 55, 0) 0%, rgb(0, 0, 0) 17%, rgba(0, 0, 0, 0.55) 26%, rgb(0, 0, 0) 35%, rgba(0, 0, 0, 0) 47%, rgba(0, 0, 0, 0.13) 69%, rgb(0, 0, 0) 79%, rgba(0, 0, 0, 0) 97%)',
              transform: 'skewX(45deg)'
            }}
          />
          <div
